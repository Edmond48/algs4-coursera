...
public class DeluxTST<Value> {
    private int n;              // size
    private Node<Value> root;   // root of DeluxTST
    ...
    // return subtrie corresponding to given key
    public Node<Value> find(Node<Value> x, char c) {
        if (x == null) {
            return null;
        }
        if (c < x.c) {
            return find(x.left, c);
        }
        else if (c > x.c) {
            return find(x.right, c);
        }
        else {
            return x;
        }
    ...
    /**
     * Unit tests the {@code DeluxTST} data type.
     *
    ...
    public static void main(String[] args) {
        ...
        DeluxTST<Integer> st = new DeluxTST<Integer>();
